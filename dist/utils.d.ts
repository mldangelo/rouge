 ...
 */
declare function factRec(x: number, acc?: number): number;
export declare const fact: typeof factRec;
/**
...
export declare const NGRAM_DEFAULT_OPTS: {
    start: boolean;
    end: boolean;
    val: string;
};
 ...
 */
export declare function nGram(tokens: string[], n?: number, pad?: {
    start?: boolean;
    end?: boolean;
    val?: string;
}): string[];
