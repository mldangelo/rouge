 ...
 */
export declare function n(cand: string, ref: string, opts?: Partial<NOpts>): number;
/**
 ...
 */
export declare function s(cand: string, ref: string, opts?: Partial<SOpts>): number;
/**
 ...
 */
export declare function l(cand: string, ref: string, opts?: Partial<LOpts>): number;
